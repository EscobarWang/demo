...
import com.example.demo.batch.ForeignExchangeTask;
...
class DemoApplicationTests {
    ...
    @Autowired(required = false)
    ForeignExchangeTask foreignExchangeTask;
    @Autowired
    ...
    void test() throws ParseException {
        ...
        foreignExchangeTask.getDailyForeignExchangeRates(dtf.parse(testTime1));
        // 未來時間:20240225(測試時間2024/1/19)，預測結果:今日無外匯成交資料
        String testTime2 = "20240225";
        log.info("日期:20240225");
        foreignExchangeTask.getDailyForeignExchangeRates(dtf.parse(testTime2));
        // 系統時間:20240119(測試時間2024/1/19)，預測結果:新增外匯成交資料成功
        String testTime3 = "20240119";
        log.info("日期:20240119");
        foreignExchangeTask.getDailyForeignExchangeRates(dtf.parse(testTime3));
    }
